...
console.log('cau 134: so hoan thien dau tien trong mang la:', question4([4, 6, 8, 9, 10, 14, 15, 20, 21, 22, 25]));
...
console.log('cau 135: so am dau tien trong mang la:', question5([4, -6, 8, 9, 10, 14, 15, 20, 21, 22, 25]));
...
console.log('cau 136: so duong cuoi cung trong mang so thuc la:', question6([3.14, -2.5, 0.75, -1.8, 2.71828, -0.5, 4.6, -9.2, 1.2, -7.3]));
...
console.log('cau 137: so am dau tien trong mang la:', question7([4, 6, 8, 9, 10, 11, 12]));
